...
class GP_DB_CLIENT_API GpDbManager final: public GpSharedPool<GpDbConnection::SP>
{
public:
    ...
    using ConnectItcPromiseT    = GpItcPromise<GpDbConnection::SP>;
    using ConnectItcFutureT     = GpItcFuture<GpDbConnection::SP>;
...
protected:
    ...
    virtual ReleaseAction               OnRelease               (GpDbConnection::SP& aDbConnection) override final;
    virtual GpDbConnection::C::Opts::SP OnAcquireNoElementsLeft (void) override final;
